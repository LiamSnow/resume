...
\section{Experience}
  ...
  \subheadingliststart
    ...
    %     \entryliststart
    %         \entry{Developed FPGA-based (Xilinx Artix-7) infrared machine vision camera that tracks targets at 815 frames per second using Onsemi Python 300 Image Sensor}
    %         \entry{Worked with international PCB, lens, cable, and CNC manufacturers}
    %     \entrylistend
    \subheading
